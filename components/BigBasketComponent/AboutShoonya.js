...
const AboutShoonya = () => {
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14 lg:w-[1200px] container mx-auto py-10 p-3">
          <div className="relative border border-green-300 p-6 rounded-lg shadow-lg flex flex-col items-center w-full md:w-96 min-h-[300px]">
            <div className="absolute -top-16 p-4 rounded-full">
              <img
                src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/shoonya.svg"
                alt="Shoonya"
                className="h-20 w-20"
              />
            </div>
          ...
          <div className="relative border border-green-300 p-6 rounded-lg shadow-lg flex flex-col items-center w-full md:w-96 min-h-[300px]">
            <div className="absolute -top-16 p-4 rounded-full">
              <img
                src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/tree_growth.svg"
                alt="Tree Growth"
                className="h-20 w-20"
              />
            </div>
          ...
          <div className="relative border border-green-300 p-6 rounded-lg shadow-lg flex flex-col items-center w-full md:w-96 min-h-[300px]">
            <div className="absolute -top-16 p-4 rounded-full">
              <img
                src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/philosophy.svg"
                alt="Philosophy"
                className="h-20 w-20"
              />
            </div>
      ...
      <div className="lg:w-[923px] container mx-auto" data-aos="zoom-in">
        {/* Your Impactful Contribution: */}
        <div className="container mx-auto border-b-2 border-dotted border-[#9450AE] lg:py-5">
          <div className="flex flex-col lg:flex-row items-start h-auto p-3">
            <img
              src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/impactful_contribution.png"
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex items-start">
                  <img
                    src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/square_icon.svg"
                    alt="square icon"
        ...
        <div className="container mx-auto border-b-2 border-dotted border-[#9450AE] lg:py-5">
          <div className="flex flex-col lg:flex-row items-start h-auto p-3">
            <img
              src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/environmental_harmony.png"
        ...
        <div className="container mx-auto border-b-2 border-dotted border-[#9450AE] lg:py-5">
          <div className="flex flex-col lg:flex-row items-start h-auto p-3">
            <img
              src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/engaging_communities.png"
        ...
        <div className="container mx-auto border-b-2 border-dotted border-[#9450AE] lg:py-5">
          <div className="flex flex-col lg:flex-row items-start h-auto p-3">
            <img
              src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/tracking_progress.png"
      ...
      <div className="flex flex-col items-center my-10 min-h-auto text-center">
        <h1 className="text-5xl font-bold">Join the</h1>
        <h1 className="text-5xl font-bold text-[#00AE8E]">Green Movement</h1>

        <div className="flex flex-col lg:flex-row items-center lg:space-x-20 my-10">
          <div className="flex flex-col items-center max-w-xs mb-10 lg:mb-0">
            <img
              src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/sustainable_future.png"
          ...
          <div className="flex flex-col items-center max-w-xs">
            <img
              src="https://s3.ap-south-1.amazonaws.com/com.cg.ivista.mediafiles/big_basket/green_community.png"
              alt="green community"
              className="w-16 h-16"
            />
            <p className="mt-4">
