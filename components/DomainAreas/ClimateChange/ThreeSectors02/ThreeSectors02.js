      ...
      <ul className="flex flex-col gap-5 list-disc ps-4 text-lg text-[#404040]">
        <li>
          <p>
            ...
            (MSMEs) are significant contributors to carbon emissions. It is
            vital to help them transition to more sustainable and low-carbon
            operations. While large companies are increasingly committed to and
            able to move in a net-zero direction, it is the MSMEs who will need
            support in the transition.
          </p>
        </li>
        <li>
          <p>
            Our Approach: We assist MSMEs in implementing energy and
