...
const Header = ({ scrollToRef }) => {
  ...
  return (
    <div className="h-screen pb-12 md:pb-20 bg-[url('/banner01.png')] bg-cover flex justify-center">
      <div className="flex flex-col items-center text-white h-full gap-1 md:gap-5 mx-auto">
