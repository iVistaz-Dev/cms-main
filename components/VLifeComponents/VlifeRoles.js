    ...
    <>
      <div className="container mx-auto text-center">
        ...
        <p className="text-2xl mt-5 p-3">
          ...
          customized financial products, facilitating access to formal financial
          institutions, and providing comprehensive support services:
        </p>
        ...
        <p className="text-xl font-light mt-4 p-3">
          ...
          that are tailored to the cash flow cycles of FPOs, ensuring that they
          have the necessary funds to operate smoothly.
        </p>
        ...
        <p className="text-xl font-light mt-4 p-3">
          ...
          long-term loans with flexible repayment terms. These loans enable FPOs
          to enhance their value-addition capabilities and improve market access.
        </p>
        <p className="border-b border-dashed mt-7 border-black"></p>
        <h2 className="text-2xl font-bold text-[#7F3F97] mt-5">
          {" "}
        ...
        <p className="text-xl font-light mt-4 p-3">
          Similar to individual farmers, FPOs can benefit from revolving credit
          lines that provide them with ongoing access to funds. This flexibility
          allows FPOs to manage cash flows effectively and respond to changing
          market conditions.
        </p>
      </div>
